    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //if(validateFields()){
            ...
            try {
                ...
                String query = "INSERT INTO users(`userId`, `password`,`mailId`,`address`,`contactNumber`,`SSN`,`registrationState`)"
                + " VALUES ('"+txtUsername.getText()+"','"+txtPassword.getText()+"','"+txtEmailId.getText()+"','"+txtAddress.getText()+"','"+txtContactNo.getText()+"','"+txtSSN.getText()+"','"+regState+"')";

                Statement st = connection.createStatement();
                int rs = st.executeUpdate(query);
                if(rs>0){
                    JOptionPane.showMessageDialog(null, "Customer has been registered", "Info", JOptionPane.INFORMATION_MESSAGE);
                }
                connection.close();
