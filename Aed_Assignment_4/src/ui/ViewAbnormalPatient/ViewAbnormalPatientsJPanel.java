...
public class ViewAbnormalPatientsJPanel extends javax.swing.JPanel {
    ...
    public ViewAbnormalPatientsJPanel(JPanel userProcessContainer, PersonCatalog personCatalog) {
        initComponents();
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        ...
        Person p = (Person)tblAbnormalPatients.getValueAt(row,0);     
    ...
    private List<Person> filter(PersonCatalog personCatalog) {
        List<Person> personCopy= new ArrayList<Person>();
        personList= new ArrayList<Person>();
        personList.addAll(personCatalog.getPersonCatalog());
